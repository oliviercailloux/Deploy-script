#Maven release plugin has two problems. The message it creates for the git annotated tag can’t be changed (hence a bad release message on GitHub); and the prepare goal creates an unnecessary and improperly aligned <tag> element in the POM. 

#Required for maven-javadoc-plugin
JAVA_HOME=/usr/lib/jvm/java-11-openjdk-amd64/

mvn -Dmaven.version.rules=file:///home/olivier/Logiciels/Développement/rules.xml org.codehaus.mojo:versions-maven-plugin:2.8.1:display-dependency-updates
